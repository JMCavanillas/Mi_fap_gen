...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/mi_fap_gen

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/mi_fap_gen: ${OBJECTFILES}
...
${OBJECTDIR}/AlgoritmosGeneticos.o: AlgoritmosGeneticos.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AlgoritmosGeneticos.o AlgoritmosGeneticos.cpp

${OBJECTDIR}/Especimen.o: Especimen.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Especimen.o Especimen.cpp
...
${OBJECTDIR}/Poblacion.o: Poblacion.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Poblacion.o Poblacion.cpp
...
${OBJECTDIR}/Transistor.o: Transistor.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Transistor.o Transistor.cpp
